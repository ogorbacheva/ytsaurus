...
**A:** You can use the `$table_name` and `$table_path` virtual columns. For more information about the virtual columns, see [Working with YTsaurus tables](../../user-guide/data-processing/chyt/yt-tables.md##virtual_columns).
