...
### Launch
Monitoring services are created by the YTsaurus operator automatically. To collect metrics, you need to:
...
## Monitoring methods and important YTsaurus metrics
...
A list of the most important qualitative checks in YTsaurus:
...
There are checks of the self-diagnosis messages of the YTsaurus cluster's subsystems:
