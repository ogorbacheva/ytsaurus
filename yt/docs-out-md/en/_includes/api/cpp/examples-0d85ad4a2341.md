...
You need to get a [YTsaurus token](../../../user-guide/storage/auth.md) before running the examples.
...
YTsaurus supports [dynamic tables](../../../user-guide/dynamic-tables/overview.md). You can perform basic operations with such tables by using the C++ wrapper.
