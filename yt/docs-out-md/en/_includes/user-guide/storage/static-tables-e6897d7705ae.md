...
In addition to static tables, the YTsaurus system supports dynamic tables. For more information about the types and features of dynamic tables, see [Dynamic tables](../../../user-guide/dynamic-tables/overview.md).

## General description { #common }

Static tables are a classic table type in the YTsaurus system.
...
Appending entries to the end of an unsorted table is the basis of many ways to load data into YTsaurus clusters.
