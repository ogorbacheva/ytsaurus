...
YTsaurus clusters host the following media types:
...
The YTsaurus system refers to such media as **transient**. To notify the system that a medium is transient, you need to set its `transient` attribute equal to `%true`.
