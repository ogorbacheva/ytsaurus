...
The general operation principles of the access control system in YTsaurus are described in the [Access control](../../../user-guide/storage/access-control.md) section.
...
This feature is actively used in the YTsaurus web interface to enable you to view data in columns to which the user has access and warn that some columns are hidden due to lack of access.
...
4. Only YTsaurus administrators can manage columnar ACEs.
