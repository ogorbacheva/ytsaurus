...
YTsaurus supports master and tablet [transactions](../../../user-guide/storage/transactions.md). Master transactions use a pessimistic locking model. This means that a lock on a Cypress node is acquired synchronously, and the system checks for potential conflicts.
