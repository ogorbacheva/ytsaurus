...
YTsaurus can run MapReduce operations on top of [sorted and ordered](../../../user-guide/dynamic-tables/overview.md#types) dynamic tables. You can also quickly (at the metadata level) convert a static table into a dynamic table.
