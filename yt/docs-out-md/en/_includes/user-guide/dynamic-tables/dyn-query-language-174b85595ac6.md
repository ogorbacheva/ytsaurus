...
| Expression | YTsaurus | In standard SQL |
| --------- | ---- | ----------------- |
...
Из репозитория YTsaurus потребуются следующие заголовочные файлы:
