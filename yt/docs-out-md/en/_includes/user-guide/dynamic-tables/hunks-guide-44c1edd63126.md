...
- <b>Fragment read request batching.</b>
    ...
    Please note that this option can significantly affect the storage layer due to a particular chunk replication load. Only set it after consulting with the YTsaurus team.
