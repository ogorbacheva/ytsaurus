...
- The pool must allow lightweight operations. This is controlled by the `enable_lightweight_operations` setting, which can be set by the YTsaurus cluster administrator.
