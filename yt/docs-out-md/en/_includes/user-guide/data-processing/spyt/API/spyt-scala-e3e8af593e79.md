...
## Differences for submitting directly to YTsaurus (from version 1.76.0) { #submit }

For submitting Spark tasks [directly to YTsaurus](../../../../../user-guide/data-processing/spyt/launch.md#submit) a `SparkSession` object should be created according to Spark recommendations:
