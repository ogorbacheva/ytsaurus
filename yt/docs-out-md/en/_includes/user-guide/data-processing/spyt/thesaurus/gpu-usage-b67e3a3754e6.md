...
In task execution, some computations can be performed on GPU devices. You can read about GPU resource scheduling in YTsaurus [here](../../../../../user-guide/data-processing/overview#podderzhka-gpu).
