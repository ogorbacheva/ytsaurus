...
SPYT 1.77.0 introduced support for [streaming processes](https://spark.apache.org/docs/latest/streaming/index.html) over YTsaurus.
...
## Streaming YTsaurus queues { #queues }

YTsaurus has its own implementation of [queues](../../../../user-guide/dynamic-tables/queues.md) based on ordered dynamic tables.
...
Spark Structured Streaming running over YTsaurus queues provides the `at-least-once` guarantee.
...
|--------------------------------------------------------|---------------------------------------------------------------------------------|
| YTsaurus checkpoint storage | 1.77.0 |
| Structured Streaming over the YTsaurus Queue API | 1.77.0 |
