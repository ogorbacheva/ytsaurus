...
For static tables, YTsaurus supports automatic chunk merge on the master server side. Unlike the [Merge](../../../../user-guide/data-processing/operations/merge.md) operation, this method doesn't use the computing resources of the pool.
