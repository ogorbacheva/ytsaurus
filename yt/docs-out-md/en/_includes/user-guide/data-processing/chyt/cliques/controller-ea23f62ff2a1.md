...
- Generate the appropriate [instance configurations](../../../../../user-guide/data-processing/chyt/reference/configuration.md) based on the clique configuration and YTsaurus cluster configuration.
...
All the commands have the optional `--proxy` parameter for setting the YTsaurus cluster to access the cliques from:
