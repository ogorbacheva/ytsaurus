...
vcsPath: en/yql/builtins/aggregation.md
sourcePath: en/yql/builtins/aggregation.md
---
# Aggregate functions
...
Get the value for an expression specified as an argument, for one of the table rows. Gives no guarantee of which row is used. This function is similar to [any()](https://clickhouse.tech/docs/en/sql-reference/aggregate-functions/reference/any/) in ClickHouse.
