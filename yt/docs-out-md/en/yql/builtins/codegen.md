...
vcsPath: en/yql/builtins/codegen.md
sourcePath: en/yql/builtins/codegen.md
---

# Functions for working with code generation

During computations, you can generate code consisting of S-expression nodes. To do this, use a mechanism for representing code packed in a [resource](../types/special.md). After constructing the code, you can insert it into the main program using the [EvaluateCode](#evaluatecode) function. For debugging, you can convert the code into a string using the [FormatCode](#formatcode) function.
