...
vcsPath: en/yql/syntax/insert_into.md
sourcePath: en/yql/syntax/insert_into.md
---
# INSERT INTO
...
* `COMPRESSION_CODEC=codec_name` to write data with the specified compression codec. Takes priority over the `yt.PublishedCompressionCodec` pragma. For permitted values, see the [Compression](https://ytsaurus.tech/docs/en/user-guide/storage/compression) section.
* `ERASURE_CODEC=erasure_name` to write data with the specified erasure codec. Takes priority over the `yt.PublishedErasureCodec` pragma. For permitted values, see the [Erasure coding](https://ytsaurus.tech/docs/en/user-guide/storage/replication#erasure) section.
...
* `MEDIA=yson` to set the media. Takes priority over the `yt.PublishedMedia` pragma. For permitted values, see the [Media](https://ytsaurus.tech/docs/en/user-guide/storage/media) section.
