...
vcsPath: en/yql/syntax/pragma/file.md
sourcePath: en/yql/syntax/pragma/file.md
---
# Working with files
...
|-------------------------|-------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| `bypass_artifact_cache` | `true`/`false` | Manages [caching](https://ytsaurus.tech/docs/en/user-guide/data-processing/operations/operations-options#fajly) |
...
```
  ...
  For PRAGMA `Package`, only links to directories on YTsaurus clusters are supported.
