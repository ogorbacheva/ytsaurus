...
vcsPath: en/yql/udf/python.md
sourcePath: en/yql/udf/python.md
---
...
```
Can be used in combination with [PROCESS](../syntax/process.md) for stream table processing, for example:
```yql
$udf = Python::process(
Callable<
    (List<Struct<
