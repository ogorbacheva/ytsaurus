...
vcsPath: en/yql/udf/list/streaming.md
sourcePath: en/yql/udf/list/streaming.md
---
# Streaming UDF
...
If you're interested in a specific interaction with a child process that's different from the line-by-line approach described above, tell us about your use scenario in the [community chat](https://t.me/ytsaurus).
