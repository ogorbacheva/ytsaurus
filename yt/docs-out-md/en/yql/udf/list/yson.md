...
vcsPath: en/yql/udf/list/yson.md
sourcePath: en/yql/udf/list/yson.md
---
# Yson


[YSON](https://ytsaurus.tech/docs/en/user-guide/storage/yson) is a data format similar to JSON developed by Yandex.
