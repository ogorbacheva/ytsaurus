...
UDF на [C++](../udf/cpp.md) подключаются в скомпилированном в `.so` виде, а также доступен широкий набор [предустановленных](../udf/list/pcre.md). UDF на [Python](../udf/python.md) могут использовать скрипт из любой строки внутри запроса, но требуют дополнительного описания своей сигнатуры.
