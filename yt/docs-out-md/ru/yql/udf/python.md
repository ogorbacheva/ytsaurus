...
vcsPath: ru/yql/udf/python.md
sourcePath: ru/yql/udf/python.md
---
...
```
Можно использовать в сочетании с [PROCESS](../syntax/process.md) для потоковой обработки таблиц, например:
```yql
$udf = Python::process(
Callable<
    (List<Struct<
