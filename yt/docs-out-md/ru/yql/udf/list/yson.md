...
vcsPath: ru/yql/udf/list/yson.md
sourcePath: ru/yql/udf/list/yson.md
---
# Yson

[YSON](https://ytsaurus.tech/docs/ru/user-guide/storage/yson) — разработанный в Яндексе формат данных, похожий на JSON.
