...
vcsPath: ru/yql/udf/list/streaming.md
sourcePath: ru/yql/udf/list/streaming.md
---
# Streaming UDF
...
Если вас интересует какой-либо формат взаимодействия с дочерним процессом, отличный от описанного выше построчного, расскажите нам о своём сценарии использования в [коммьюнити-чате](https://t.me/ytsaurus_ru).
