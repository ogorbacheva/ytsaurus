...
vcsPath: ru/yql/syntax/insert_into.md
sourcePath: ru/yql/syntax/insert_into.md
---
...
* `COMPRESSION_CODEC=codec_name` &mdash; записать данные с указанным compression codec. Имеет приоритет над прагмой `yt.PublishedCompressionCodec`. Допустимые значения смотрите в разделе [Сжатие](https://ytsaurus.tech/docs/ru/user-guide/storage/compression#compression_codecs).
* `ERASURE_CODEC=erasure_name` &mdash; записать данные с указанным erasure codec. Имеет приоритет над прагмой `yt.PublishedErasureCodec`. Допустимые значения смотрите в разделе [Репликация](https://ytsaurus.tech/docs/ru/user-guide/storage/replication#erasure).
...
* `MEDIA=yson` &mdash; указать медиумы. Имеет приоритет над прагмой `yt.PublishedMedia`. Допустимые значения смотрите в разделе [Медиумы](https://ytsaurus.tech/docs/ru/user-guide/storage/media)
