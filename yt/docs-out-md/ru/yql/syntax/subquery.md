...
vcsPath: ru/yql/syntax/subquery.md
sourcePath: ru/yql/syntax/subquery.md
---
...
$myProcess2 = ($world, $nestedQuery, $lambda) -> {
    -- Если использовать ListFlatMap или YQL::OrderedFlatMap, то получится Ordered YTsaurus Map операция
