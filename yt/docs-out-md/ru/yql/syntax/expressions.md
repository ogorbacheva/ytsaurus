...
vcsPath: ru/yql/syntax/expressions.md
sourcePath: ru/yql/syntax/expressions.md
---
# Выражения
...
{% include [decimal_args](../_includes/decimal_args-1f6162e4d019.md) %}

#### Примеры

{% include [cast_examples](../_includes/cast_examples-a31dc865b2cd.md) %}
