# YTsaurus JavaScript Wrapper (Browser + Node.js)

Враппер для запросов к кластерам YTsaurus, который использует HTTP API YTsaurus с наиболее приближенным к нему интерфейсом.
