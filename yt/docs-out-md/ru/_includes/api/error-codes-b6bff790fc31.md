...
В данном разделе собрана информация о кодах ошибок, которые могут возникать при работе с системой YTsaurus.
...
Зарегистрированные коды ошибок можно увидеть, [поискав](https://github.com/search?q=repo%3Aytsaurus%2Fytsaurus+path%3A%2F%5Eyt%5C%2F%2F+YT_DEFINE_ERROR_ENUM&type=code) в кодовой базе конструкцию `YT_DEINE_ERROR_ENUM`.
