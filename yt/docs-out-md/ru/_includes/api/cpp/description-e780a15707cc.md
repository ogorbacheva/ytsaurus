...
Для использования возможностей системы YTsaurus существует [C++ клиент](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce).
...
См. [yt/cpp/mapreduce/interface/io.h](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce/interface/io.h).
...
Для более тонкой настройки форматов существует класс [TFormatHints](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce/interface/client_method_options.h). Его можно передавать в полях `TTableReaderOptions::FormatHints` и `TTableWriterOptions::FormatHints` при создании reader/writer.
...
Для параллельного чтения таблиц есть [библиотека](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce/library/parallel_io/parallel_reader.h).

## Запуск операций { #operations }

См. [по ссылке](https://github.com/ytsaurus/ytsaurus/tree/main/yt/cpp/mapreduce/interface/operation.h).
