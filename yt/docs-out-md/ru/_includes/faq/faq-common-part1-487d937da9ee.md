#### **Q: Как добавить колонку в таблицу YTsaurus?** {#add-column-to-table}
...
------
#### **Q: Является ли чтение таблицы (или файла) в YTsaurus консистентной операцией? Что будет, если читать таблицу и одновременно с этим её удалить?** {#consistent-read-operation}
