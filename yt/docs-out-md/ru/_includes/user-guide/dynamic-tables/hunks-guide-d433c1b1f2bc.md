...
| --- | --- |
| `proxy` | Название YTsaurus кластера |
...
- <b>Батчинг запросов фрагментов.</b>
    ...
    Данная опция может заметно влиять на слой хранения за счет особой нагрузки по репликации чанков. Стоит выставлять ее только после консультации с командой YTsaurus.
