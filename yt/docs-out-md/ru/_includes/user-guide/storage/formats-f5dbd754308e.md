...
YAML доступен в YTsaurus начиная с версии 24.2.
...
Формат YAML в YTsaurus использует подход на основе [схемы YAML](https://yaml.org/spec/1.2.2/#schema) для определения типов. Реализация следует [Core схеме](https://yaml.org/spec/1.2.2/#core-schema), которая широко используется большинством парсеров YAML:
