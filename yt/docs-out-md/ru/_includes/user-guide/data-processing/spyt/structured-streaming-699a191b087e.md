...
В версии SPYT 1.77.0 появилась поддержка [стриминговых процессов](https://spark.apache.org/docs/latest/streaming/index.html) поверх YTsaurus.
...
## Стриминг очередей YTsaurus { #queues }

YTsaurus имеет собственную реализацию [очередей](../../../../user-guide/dynamic-tables/queues.md), основанных на упорядоченных динамических таблицах.
...
Spark Structured Streaming, работающий поверх YTsaurus очередей, предоставляет гарантию `at-least-once`.
...
|--------------------------------------------------------|---------------------------------------------------------------------------------|
| Хранение чекпоинтов на YTsaurus                | 1.77.0                                                                          |
| Structured Streaming поверх YTsaurus Queue API | 1.77.0                                                                          |
