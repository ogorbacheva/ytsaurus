...
В текущей реализации есть два варианта запуска Spark задач: [с использованием планировщика YTsaurus](../../../../../user-guide/data-processing/spyt/launch.md#submit), либо с использованием внутреннего Spark Standalone кластера, который разворачивается внутри Vanilla операции.
