...
| `--params` | нет | - | Дополнительные параметры YTsaurus операции, указываются в виде YSON строки. Подробнее - на странице [конфигурации](../../../../../user-guide/data-processing/spyt/cluster/configuration.md#add) | - |
...
| `--ssd-account` | нет | - | YTsaurus [Аккаунт](../../../../../user-guide/storage/accounts.md), используемый для выделения SSD | - |
