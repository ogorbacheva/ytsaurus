...
При исполнении задач некоторые вычисления могут быть произведены на GPU устройствах. Про планирование GPU ресурсов в YTsaurus можно прочесть в соответствующей [статье](../../../../../user-guide/data-processing/overview#podderzhka-gpu).
