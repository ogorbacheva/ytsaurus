...
## Способы запуска расчетов на Spark в YTsaurus { #submit }

- Отдельные запуски расчётов напрямую в YTsaurus, используя команду `spark-submit` [Подробнее](../../../../user-guide/data-processing/spyt/launch.md#submit).
- Создание Standalone Spark кластера как постоянного ресурса внутри YTsaurus при помощи Vanilla операции [Подробнее](../../../../user-guide/data-processing/spyt/launch.md#standalone).
