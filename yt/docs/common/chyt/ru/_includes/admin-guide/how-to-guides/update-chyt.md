...
Перед обновлением CHYT проверьте совместимость версий CHYT, {{product-name}} и Strawberry {{ chyt-admin-guide-how-to-guides-update-chyt-md-audience-1 }}
...
{{ chyt-admin-guide-how-to-guides-update-chyt-md-audience-2 }}
