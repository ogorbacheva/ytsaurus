...
Логи всех запросов сохраняются в таблицах. Они находятся в {{ chyt-user-guide-how-to-guides-queries-get-query-logs-md-audience-1 }} по адресу: `//sys/strawberry/chyt/<alias>/artifacts/system_log_tables/query_log`.
...
1. Перейдите в [веб‑интерфейс]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) клики.
1. В [Панели вкладок]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs) выберите вкладку **Query Logs**.
