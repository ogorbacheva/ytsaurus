...
Чтобы настроить клику, у вас должно быть право `manage` на эту клику. Проверьте, есть ли у вас этот тип прав, на вкладке **ACL** на [Панели вкладок]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs) в разделе **Object permissions**.
