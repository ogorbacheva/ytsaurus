...
1. Откройте веб-интерфейс YT‑операции (1), как описано в разделе [Как попасть в веб-интерфейс YT-операции]({{ docs_root }}/chyt/user-guide/reference/cliques/yt-operation-ui.md#get-to-section).
...
1. Чтобы выгрузить лог джоба, в поле **Stderr** (5) нажмите ![download](../../../_images/user-guide/how-to-guides/download-log.png){width=24 height=24}.
