...
- Правильная генерация [конфигурации инстансов]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md) из предоставленной конфигурации клики и из конфигурации кластера {{product-name}}.
- Запуск и перезапуск Vanilla-операций клики в случае их аварийного завершения из-за неполадок или работ на кластере.

{{ chyt-user-guide-explanation-controller-md-audience-1 }}
...
{{ chyt-user-guide-explanation-controller-md-audience-2 }}
...
Все выставленные опции можно посмотреть с помощью команды [get-speclet](#get-speclet). Описание всех доступных опций приведено в разделе [Конфигурация]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md#options).
...
Опции клики, доступные для установки через команду `set-option`, можно посмотреть в разделе [Конфигурация]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md#options).
