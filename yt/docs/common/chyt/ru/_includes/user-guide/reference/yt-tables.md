...
Более подробное описание этих функций приведено в разделе [Чтение множества таблиц]({{ docs_root }}/chyt/user-guide/reference/functions.md#multiple_tables_read).
