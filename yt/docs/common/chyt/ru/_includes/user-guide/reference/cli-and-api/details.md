...
Детальную спецификацию возможностей Python API и CLI вы можете найти в статье [Выполнение запросов]({{ docs_root }}/chyt/user-guide/reference/queries/execute.md).
