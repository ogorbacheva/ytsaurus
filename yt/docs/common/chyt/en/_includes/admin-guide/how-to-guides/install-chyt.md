...
Once all jobs are successfully completed, you can run the `CHYT` clique. For more information about cliques, see [this section]({{ docs_root }}/chyt/user-guide/explanation/cliques/overview.md).
