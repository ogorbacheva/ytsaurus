...
- Viewing the **Speclet** tab in the [web interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) on the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs).
...
- The web interface: click ![](../../../../_images/user-guide/reference/cliques/edit-btn.png){width=24 height=24} **Edit speclet** in the upper‑right corner, in the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) block, or the button **Edit Speclet** tab on the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui).

For step‑by‑step instructions and practical examples of setting options, see the [Adding compute resources]({{ docs_root }}/chyt/user-guide/how-to-guides/cliques/manage-resources.md) and [Configuring advanced settings]({{ docs_root }}/chyt/user-guide/how-to-guides/cliques/configure-advanced-settings.md) sections.

### Available options { #options }

Below are the clique options available for configuration via the [web interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md) or via the CLI with `set-option` command (default values are shown in square brackets).
...
- **Basic options** — *General* tab
    ...
    In the web interface, use the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) to start and stop the clique ||
    ...
    For more information about preemption, see the [Resources and preemption]({{ docs_root }}/chyt/user-guide/explanation/resources.md) section ||
...
- **Advanced options** — *Advanced* tab
    ...
    These settings are intended for advanced users only. If you’re unsure whether you need them, we recommend keeping the default values. For more information, see the [Configuring advanced settings]({{ docs_root }}/chyt/user-guide/how-to-guides/cliques/configure-advanced-settings.md) section.
...
[Adding compute resources]({{ docs_root }}/chyt/user-guide/how-to-guides/cliques/manage-resources.md)  
[Configuring advanced settings]({{ docs_root }}/chyt/user-guide/how-to-guides/cliques/configure-advanced-settings.md)
