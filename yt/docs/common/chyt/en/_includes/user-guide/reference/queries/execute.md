...
You can use this command to execute a random query in the clique. Also see the [How to try]({{ docs_root }}/chyt/user-guide/how-to-guides/try-chyt.md) article which lists alternative ways to query a CHYT clique.
