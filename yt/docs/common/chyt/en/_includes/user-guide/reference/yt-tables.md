...
For more information about these functions, see [Reading a set of tables]({{ docs_root }}/chyt/user-guide/reference/functions.md#multiple_tables_read).
