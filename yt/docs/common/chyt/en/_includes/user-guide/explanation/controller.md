...
- Generate the appropriate [instance configurations]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md) based on the clique configuration and {{product-name}} cluster configuration.
...
To view all the set options, run the [get-speclet](#get-speclet) command. For a description of all available options, see [Configuration]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md#options).
...
For a list of the clique options that can be set by the `set-option` command, see [Configuration]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md#options).
