...
![](../../../../../_images/user-guide/explanation/queries/chyt_inside_clique.png)
...
If you believe that migrating your data to an SSD will speed up query execution{{ chyt-user-guide-explanation-queries-anatomy-md-audience-2 }}, follow the [action plan]({{ docs_root }}/chyt/user-guide/reference/faq.md#how-to-set-ssd) provided in the FAQ.
