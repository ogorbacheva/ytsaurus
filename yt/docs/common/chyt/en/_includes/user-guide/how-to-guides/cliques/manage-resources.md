...
To configure a clique, you must have the `manage` permission for that clique. Check whether you have this permission type on the **ACL** tab in the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs) under **Object permissions**.
...
- Through the web interface
    ...
    1. Click ![edit speclet](../../../../_images/user-guide/how-to-guides/cliques/edit-btn.png){width=24 height=24} in the upper-right corner of the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) section or the button **Edit speclet** on the **Speclet** tab in the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs).
