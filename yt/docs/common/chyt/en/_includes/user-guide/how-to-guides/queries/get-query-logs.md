...
1. Open the [web interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) of the clique.
1. In the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs), select the **Query Logs** tab.
