...
- Using the CLI
  ...
  1. Install [CHYT CLI]({{ docs_root }}/chyt/user-guide/reference/cli-and-api.md) as part of the `ytsaurus-client` package, if you haven’t done so yet.
  ...
  1. Create a clique using a command from [CHYT Controller CLI]({{ docs_root }}/chyt/user-guide/explanation/controller.md):
...
After creating a clique, you need to configure it — set the required [options]({{ docs_root }}/chyt/user-guide/reference/cliques/configs.md#options). The main option for starting a clique is `pool`; you need to pass the name of the compute pool where the clique instances will run.

Before setting the `pool` option, make sure you have the `Use` permission for the specified pool. Check your permissions on the **ACL** tab in the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) in the **Object permissions** section. If you’re unsure which pool to use, contact the {{product-name}} cluster administrator.
...
- Web interface
  ...
  1. Open the clique interface as described in the [How to open the clique interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where) section.
  1. Click ![edit speclet](../../../../_images/user-guide/how-to-guides/cliques/edit-btn.png){width=24 height=24} in the upper‑right corner, in the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui) block, or the button **Edit speclet** on the **Speclet** tab in the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui).
...
Now the clique is configured and all settings are saved in the [speclet]({{ docs_root }}/chyt/user-guide/reference/cliques/configs.md#speclet) in Cypress.
...
- Web interface
  ...
  1. Open the clique interface as described in the [How to open the clique interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where) section.
  1. Click ![start](../../../../_images/user-guide/how-to-guides/cliques/start-btn.png){width=24 height=24} in the upper‑right corner, in the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block.
  1. Make sure that:
     ...
     You can view the statuses of these parameters in the clique interface — in the block with [characteristics]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#ui).
  1. Check the clique’s functionality. To do this, make a test query in the **Query Tracker** interface:
     - click ![sql](../../../../_images/user-guide/how-to-guides/cliques/sql-btn.png){width=24 height=24} in the upper‑right corner, in the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block;
...
- Web interface
  ...
  1. Open the clique interface as described in the [How to open the clique interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where) section.
  1. Click ![stop](../../../../_images/user-guide/how-to-guides/cliques/stop-btn.png){width=24 height=24} in the upper‑right corner, in the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block.
  1. Make sure that:
