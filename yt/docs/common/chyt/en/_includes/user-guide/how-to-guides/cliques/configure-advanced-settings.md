...
This section describes how to work with advanced clique settings. In the web interface, they are located in the *Advanced settings* section. The complete list of advanced settings is provided in the [Advanced settings]({{ docs_root }}/chyt/user-guide/reference/cliques/configs.md#options) section.
...
- Web interface
    ...
    1. Click ![edit speclet](../../../../_images/user-guide/how-to-guides/cliques/edit-btn.png){width=24 height=24} in upper-right corner of the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block or the button **Edit speclet** on the **Speclet** tab in the [Tab panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs).
...
- CLI
    ...
    1. Install the [CHYT CLI]({{ docs_root }}/chyt/user-guide/reference/cli-and-api.md) as part of the `ytsaurus-client` package, if you haven’t done so already.
...
- Web interface
    ...
    1. Open the clique interface as described in the [How to open the clique interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where) section.
    1. Click ![edit speclet](../../../../_images/user-guide/how-to-guides/cliques/edit-btn.png){width=24 height=24} in the upper-right corner of the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block or the button **Edit speclet** on the **Speclet** tab in the [Tab panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs).
    1. Select the **Advanced** section on the left.
...
You can view the list of available YT configuration parameters in the [Instance configuration]({{ docs_root }}/chyt/user-guide/reference/cliques/configuration.md#yt_config) section.
...
![memory](../../../../_images/user-guide/how-to-guides/cliques/chyt_memory.png)
...
![memory](../../../../_images/user-guide/how-to-guides/cliques/chyt_memory_rss.png)
...
{% include [memory-usage-warning](../_partials/memory-usage-warning.md) %}
