...
- Web interface
    ...
    1. Go to the [web interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where) of the clique.
...
- Query to the clique
    ...
    1. Go to the Query Tracker web interface: click ![sql](../../../_images/user-guide/how-to-guides/sql-btn.png){width=24 height=24} in the upper-right corner of the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block.
