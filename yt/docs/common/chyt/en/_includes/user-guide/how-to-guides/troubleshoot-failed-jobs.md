...
![Failed Jobs](../../../_images/user-guide/how-to-guides/failed-jobs.png){ .center }

1. Open the YT operation web interface (1), as described in the section [How to open the YT operation web interface]({{ docs_root }}/chyt/user-guide/reference/cliques/yt-operation-ui.md#get-to-section).
...
1. To download the job log, click ![download](../../../_images/user-guide/how-to-guides/download-log.png){width=24 height=24} in the **Stderr** field (5) .
