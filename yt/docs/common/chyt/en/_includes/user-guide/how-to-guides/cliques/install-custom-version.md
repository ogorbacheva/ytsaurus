...
1. Open the clique interface as described in the section [How to open the clique interface]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#where).
1. Click ![edit speclet](../../../../_images/user-guide/how-to-guides/cliques/edit-btn.png){width=24 height=24} **Edit speclet** in the upper-right corner of the [Action buttons]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#action-menu) block, or the button **Edit speclet** on the **Speclet** tab in the [Tabs panel]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md#tabs).
...
[Clique web interface in {{product-name}}]({{ docs_root }}/chyt/user-guide/reference/cliques/ui.md)  
[Getting CHYT and ClickHouse versions]({{ docs_root }}/chyt/user-guide/how-to-guides/check-versions.md)
