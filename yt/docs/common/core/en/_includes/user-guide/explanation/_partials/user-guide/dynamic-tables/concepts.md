...
Each table, including a static one, has the `tablet_cell_bundle` attribute where the name of the bundle to which cells this table will be mounted is stored. For more information about mounting, see [Table mounting]({{ docs_root }}/core/user-guide/reference/dynamic-tables/operations#mount_table).
...
| tablet_cell_ids[*]({{ docs_root }}/_includes/user-guide/dynamic-tables/**) | Guid | IDs of cells in a bundle. |
