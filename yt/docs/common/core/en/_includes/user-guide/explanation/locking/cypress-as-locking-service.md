...
{% include [Distributed locks](../_partials/user-guide/locking/cypress-as-locking-service-p1.md) %}
...
{% include [Distributed locks](../_partials/user-guide/locking/cypress-as-locking-service-p2.md) %}

## Quotas

{% include [Distributed locks](../_partials/user-guide/locking/cypress-as-locking-service-p3.md) %}
