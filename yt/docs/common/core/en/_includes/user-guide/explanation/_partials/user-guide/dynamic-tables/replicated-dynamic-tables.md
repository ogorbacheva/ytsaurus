...
Both [sorted]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/overview) and [ordered]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/ordered-dynamic-tables) dynamic tables can be replicated. Replicas can be **synchronous** and **asynchronous**. A successful write transaction commit ensures that the data is in synchronous replication and in the replication queue. Data will be written to asynchronous replicas in the background. For more information, see [Replication](#replication).
...
If you want to add a replica by fully copying the data of an existing replica, use the {{ core-user-guide-explanation-dynamic-tables-replicated-dynamic-tables-md-audience-1 }}.
...
{{ core-user-guide-explanation-dynamic-tables-replicated-dynamic-tables-md-audience-2 }}
...
| errors | Error[*]({{ docs_root }}/_includes/user-guide/dynamic-tables/*error) | List of replication errors for this replica |
...
| tablets | TabletReplicaInfo[*]({{ docs_root }}/_includes/user-guide/dynamic-tables/**) | Description of tablet states. The position in the list corresponds to the tablet index in the table itself |
