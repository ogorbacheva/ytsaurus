...
Job collectives are not the same as [gang operations]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operations). A gang operation restarts **all** its jobs when any non-backup job is restarted, whereas job collectives restart jobs only in a **single** collective (the one processing a given data batch).
...
[Gang operations]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operations) are a type of Vanilla operations, so when you need to run an operation of a different type, operations with job collectives are the only option.
...
- Gang operations provide more guarantees (which, in particular, make restarting a collective more optimal) (see [Restarting a gang operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operation-restart)).
- In contrast to gang operations, operations with job collectives do not support backup jobs (see [Backup jobs]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#reserved-jobs)).
- In contrast to gang operations, operations with job collectives can have output tables (see [Limitations and considerations]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operation-limitations)).
...
|----------|-----------------------------------|
| [Map]({{ docs_root }}/core/user-guide/reference/data-processing/operations/map) | In the `mapper` specification |
| [Reduce]({{ docs_root }}/core/user-guide/reference/data-processing/operations/reduce) | In the `reducer` specification |
| [MapReduce]({{ docs_root }}/core/user-guide/reference/data-processing/operations/mapreduce) | In the `mapper`, `reducer`, or `reduce_combiner` specification |
| [Vanilla]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla) | In the task specification |
...
* **Incompatibility with gang_options**: You cannot use job collectives together with [gang operations]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operations). If you attempt to specify both parameters, the operation will fail with an error.
...
* [Gang operations]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla#gang-operations)
* [Map operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/map)
* [Reduce operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/reduce)
* [MapReduce operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/mapreduce)
* [Vanilla operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla)
