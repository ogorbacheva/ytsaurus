...
![](../../../../../../../_images/user-guide/reference/data-processing/operations/mapreduce_op1.png){ .center }

The MapReduce operation is similar to the [Sort]({{ docs_root }}/core/user-guide/reference/data-processing/operations/sort) operation, but allows for executing a mapper user script before partitioning jobs, and a reducer user script after sorting jobs.
...
The merged MapReduce operation has several advantages over the [Map]({{ docs_root }}/core/user-guide/reference/data-processing/operations/map) + [Sort]({{ docs_root }}/core/user-guide/reference/data-processing/operations/sort) + [Reduce]({{ docs_root }}/core/user-guide/reference/data-processing/operations/reduce) combination:
...
![](../../../../../../../_images/user-guide/reference/data-processing/operations/mapreduce_op2.png){ .center }
...
General parameters for all operation types are described in [Operation options]({{ docs_root }}/core/user-guide/reference/data-processing/operations/operations-options).
...
* `intermediate_data_medium` (default) — [type of medium]({{ docs_root }}/core/user-guide/reference/storage/media) to write chunks of intermediate data to.
...
* `pivot_keys` — list of keys to be used for data partitioning at the reduce phase. This option is exactly the same as the corresponding reduce [option]({{ docs_root }}/core/user-guide/reference/data-processing/operations/reduce).
