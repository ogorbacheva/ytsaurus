...
{% include [Local emulation](../_partials/user-guide/problems/mapreduce-debug/local-emulation.md) %}

{% include [Stderr running](../_partials/user-guide/problems/mapreduce-debug/stderr-running.md) %}
...
- In SDKs in other languages
  ...
  You can pass the `stderr_table_path` setting directly to the operation specification. For a description of this option, see [Operation options]({{ docs_root }}/core/user-guide/reference/data-processing/operations/operations-options).

{% endlist %}

{% include [Stderr table](../_partials/user-guide/problems/mapreduce-debug/stderr-table.md) %}
