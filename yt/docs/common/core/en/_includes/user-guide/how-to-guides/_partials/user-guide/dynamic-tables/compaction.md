...
- Apply [delete tombstones]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/sorted-dynamic-tables#udalenie-stroki) and physically delete rows.
- Delete old versions.
...
For more information about these attributes, see [Deleting old data]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/sorted-dynamic-tables#remove_old_data).
...
{{ core-user-guide-how-to-guides-dynamic-tables-compaction-md-audience-1 }}
...
{{ core-user-guide-how-to-guides-dynamic-tables-compaction-md-audience-3 }}
...
{{ core-user-guide-how-to-guides-dynamic-tables-compaction-md-audience-4 }}
