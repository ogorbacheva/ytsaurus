...
To use the [YSON]({{ docs_root }}/core/user-guide/reference/storage/yson) format of data representation, you can install the so called YSON bindings.
...
If you have any problems, check the [FAQ]({{ docs_root }}/core/user-guide/reference/faq) section.
