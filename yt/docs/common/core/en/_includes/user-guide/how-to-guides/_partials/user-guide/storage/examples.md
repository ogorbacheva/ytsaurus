...
The `--format` option defines the output data format. The supported formats are `json`, `yson`, `dsv`, and `schemaful_dsv`. For more information, see [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats).
...
The `--format` option defines the input data format. The supported formats are `json`, `yson`, `dsv`, and `schemaful_dsv`. For more information, see [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats).
