...
To implement the above steps, use the script indicated in the [MapReduce for dynamic tables]({{ docs_root }}/core/user-guide/how-to-guides/dynamic-tables/mapreduce) section.
