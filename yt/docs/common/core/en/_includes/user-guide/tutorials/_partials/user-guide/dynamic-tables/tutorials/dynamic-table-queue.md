...
For more information about cleaning up and splitting ordered dynamic tables into tablets, see [Ordered dynamic tables]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/ordered-dynamic-tables).
