...
This section describes the annotations of tables, directories, and other [Cypress]({{ docs_root }}/core/concepts/storage/cypress) nodes.
...
All Cypress nodes have the `annotation` attribute with the [YSON string]({{ docs_root }}/core/reference/storage/yson) value. You can set the value, as for the other attributes:
