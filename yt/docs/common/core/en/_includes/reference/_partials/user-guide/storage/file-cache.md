...
The file cache enables you to upload a file to [Cypress]({{ docs_root }}/core/concepts/storage/cypress) once and then obtain a path to the file multiple times via a specified [MD5 hash](https://en.wikipedia.org/wiki/MD5).
