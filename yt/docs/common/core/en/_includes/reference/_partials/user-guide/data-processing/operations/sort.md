...
* `intermediate_data_medium` (`default`) — type of [medium]({{ docs_root }}/core/reference/storage/media) storing chunks of intermediate data produced by sorting.
...
* `schema_inference_mode` (auto) — schema definition mode. Possible values: auto, from_input, from_output. For more information, see the [Data schema]({{ docs_root }}/core/reference/storage/static-schema#schema_inference) section.
