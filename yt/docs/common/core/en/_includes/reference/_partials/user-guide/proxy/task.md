...
- The first row represents a [vanilla]({{ docs_root }}/core/reference/data-processing/operations/vanilla) operation with an HTTP server example.
...
- The third and fourth rows correspond to a SPYT [standalone]({{ docs_root }}/user-guide/data-processing/spyt/cluster/cluster-start) cluster launched with history server.
- The fifth row relates to SPYT [direct submit]({{ docs_root }}/user-guide/data-processing/spyt/direct-submit/desc).
