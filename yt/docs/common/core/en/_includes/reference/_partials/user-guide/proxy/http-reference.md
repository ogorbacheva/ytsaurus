...
- Information about the input and output data [format]({{ docs_root }}/core/reference/storage/formats) (represented as a YSON string with attributes).
...
| -------------------------------------------------------- | ------------------ | ------------------- | --------------- | ------------ | ---------------- | -------------- |
| [start_tx]({{ docs_root }}/core/reference/api/commands#starttx) |  | Structured | Yes | No | Yes | POST |
| [ping_tx]({{ docs_root }}/core/reference/api/commands#pingtx) |  |  | Yes | No | No | POST |
| [commit_tx]({{ docs_root }}/core/reference/api/commands#committx) |  |  | Yes | No | Yes | POST |
| [abort_tx]({{ docs_root }}/core/reference/api/commands#aborttx) |  |  | Yes | No | Yes | POST |
| [create]({{ docs_root }}/core/reference/api/commands#create) |  | Structured | Yes | No | Yes | POST |
| [remove]({{ docs_root }}/core/reference/api/commands#remove) |  |  | Yes | No | Yes | POST |
| [set]({{ docs_root }}/core/reference/api/commands#set) | Structured |  | Yes | No | Yes | PUT |
| [get]({{ docs_root }}/core/reference/api/commands#get) |  | Structured | No | No | No | GET |
| [list]({{ docs_root }}/core/reference/api/commands#list) |  | Structured | No | No | No | GET |
| [lock]({{ docs_root }}/core/reference/api/commands#lock) |  | Structured | Yes | No | Yes | POST |
| [copy]({{ docs_root }}/core/reference/api/commands#copy) |  | Structured | Yes | No | Yes | POST |
| [move]({{ docs_root }}/core/reference/api/commands#move) |  | Structured | Yes | No | Yes | POST |
| [link]({{ docs_root }}/core/reference/api/commands#link) |  | Structured | Yes | No | Yes | POST |
| [exists]({{ docs_root }}/core/reference/api/commands#exists) |  | Structured | No | No | No | GET |
| [write_file]({{ docs_root }}/core/reference/api/commands#writefile) | Binary | Structured | Yes | Yes | No | PUT |
| [read_file]({{ docs_root }}/core/reference/api/commands#readfile) |  | Binary | No | Yes | No | GET |
| [write_table]({{ docs_root }}/core/reference/api/commands#writetable) | Tabular |  | Yes | Yes | No | PUT |
| [read_table]({{ docs_root }}/core/reference/api/commands#readtable) |  | Tabular | No | Yes | No | GET |
| [write_journal]({{ docs_root }}/core/reference/api/commands#writejournal) | Tabular |  | Yes | Yes | No | PUT |
| [read_journal]({{ docs_root }}/core/reference/api/commands#readjournal) |  | Tabular | No | Yes | No | GET |
| [select_rows]({{ docs_root }}/core/reference/api/commands#select_rows) (0.17+) |  | Tabular | No | Yes | No | GET |
| [merge]({{ docs_root }}/core/reference/api/commands#merge) |  | Structured | Yes | No | Yes | POST |
| [erase]({{ docs_root }}/core/reference/api/commands#erase) |  | Structured | Yes | No | Yes | POST |
| [map]({{ docs_root }}/core/reference/api/commands#map) |  | Structured | Yes | No | Yes | POST |
| [reduce]({{ docs_root }}/core/reference/api/commands#reduce) |  | Structured | Yes | No | Yes | POST |
| [map_reduce]({{ docs_root }}/core/reference/api/commands#map_reduce) |  | Structured | Yes | No | Yes | POST |
| [sort]({{ docs_root }}/core/reference/api/commands#sort) |  | Structured | Yes | No | Yes | POST |
| [abort_op]({{ docs_root }}/core/reference/api/commands#abortop) |  |  | Yes | No | No | POST |
