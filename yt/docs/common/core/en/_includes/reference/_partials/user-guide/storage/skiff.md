...
Skiff (from schemaful format) is an interchange [format]({{ docs_root }}/core/reference/storage/formats) to communicate schematized data between job_proxy and a job.
