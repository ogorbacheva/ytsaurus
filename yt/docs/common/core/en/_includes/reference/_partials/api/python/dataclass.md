...
## Motivation { #motivation }
  ...
  3. Speed: due to the [Skiff]({{ docs_root }}/core/reference/storage/skiff) format and some other optimizations, CPU consumption is several times lower than for untyped data.
...
When you have a class like this, you can:
  ...
  2. Write and read [tables]({{ docs_root }}/core/how-to-guides/api/python/userdoc#table_commands), [example]({{ docs_root }}/core/how-to-guides/api/python/examples#read_write).
  3. Run [operations]({{ docs_root }}/core/how-to-guides/api/python/userdoc#python_operations), [example]({{ docs_root }}/core/how-to-guides/api/python/examples#simple_map).
