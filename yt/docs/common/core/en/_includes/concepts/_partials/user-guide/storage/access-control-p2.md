...
- Using [Job Shell]({{ docs_root }}/core/how-to-guides/problems/jobshell-and-slowjobs) requires `read` and `manage` permissions at the same time , since having access via the console enables you to read or randomly change the job state.
