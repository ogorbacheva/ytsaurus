...
As with [sorted dynamic tables]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables), the key space of an ordered dynamic table is divided into [tablets]({{ docs_root }}/core/concepts/dynamic-tables/overview#tablets).
...
Use `alter-table` to convert an ordered dynamic table into a static table and vice versa. For more information, see [MapReduce for dynamic tables]({{ docs_root }}/core/how-to-guides/dynamic-tables/mapreduce#convert_table).
