...
Dynamic tables can be [sorted]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables) and [ordered]({{ docs_root }}/core/concepts/dynamic-tables/ordered-dynamic-tables). In addition, a replication mechanism is implemented for each table type. For more information about replication, see [replicated dynamic tables]({{ docs_root }}/core/concepts/dynamic-tables/replicated-dynamic-tables).
...
For more information about the data architecture and model, see separate sections about [sorted]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables) and [ordered]({{ docs_root }}/core/concepts/dynamic-tables/ordered-dynamic-tables) dynamic tables.
...
| atomicity | Atomicity | [Atomicity mode]({{ docs_root }}/core/concepts/dynamic-tables/transactions#atomicity). By default: `full`. |
...
- [Set up background compaction]({{ docs_root }}/core/how-to-guides/dynamic-tables/compaction#attributes).
- [Set TTL]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables#remove_old_data): Time to live for individual values.
- [Manage automatic sharding]({{ docs_root }}/core/how-to-guides/dynamic-tables/tablet-balancing).
...
Besides that, dynamic tables inherit the [limitations]({{ docs_root }}/core/concepts/storage/static-tables#limitations) of static tables.
