...
Notebooks and files created on filesystem are not preserved after job restart. For the reliable storage of the files you should store them in [Cypress]({{ docs_root }}/core/concepts/storage/cypress).
