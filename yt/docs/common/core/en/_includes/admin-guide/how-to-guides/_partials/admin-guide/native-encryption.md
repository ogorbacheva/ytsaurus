...
![](../../../../../_images/admin-guide/how-to-guides/encryption-diagram-en.svg)
...
Unlike other components, CHYT runs inside a {{product-name}} [vanilla operation]({{ docs_root }}/core/user-guide/reference/data-processing/operations/vanilla), so certificates are passed in a specific way:
...
- The operation receives all security settings, including certificates and encryption parameters, via a [secure_vault]({{ docs_root }}/_includes/admin-guide/*secure_vault).
