Sometimes, you may need to know who's using a particular table, for example, to evaluate the consequences of it being moved or deleted. This might be difficult if the table is accessed by [links]({{ docs_root }}/core/user-guide/explanation/storage/objects#links).
