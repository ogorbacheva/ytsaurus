...
7. Execute a simple query and see which pods metrics are collected from:
    ...
    - Via Prometheus UI
      ...
      ![Prometheus UI](../../../../../_images/admin-guide/how-to-guides/monitoring-install-prometheus-ui-example.png)
...
8. If you have Odin installed, check if its metrics are being collected:
    ...
    Collection of qualitative metrics from [Odin]({{ docs_root }}/core/admin-guide/how-to-guides/install-odin) is carried out through a separate `ServiceMonitor` created by the Odin chart itself.
    ...
    - Via Prometheus UI
      ...
      ![Odin service in Prometheus UI](../../../../../_images/admin-guide/how-to-guides/monitoring-install-prometheus-ui-odin-example.png)
    ...
    If it is missing, you need to enable `ServiceMonitor` creation in the [chart settings]({{ docs_root }}/core/admin-guide/how-to-guides/install-odin#prepare-values).
...
For monitoring and Grafana integration to work properly, you need to pass the required addresses to the {{product-name}} UI installed via the [Helm chart]({{ docs_root }}/core/admin-guide/how-to-guides/install-ytsaurus#ui). When installing the monitoring chart, these variables will be automatically checked for existence.
...
![{{product-name}} UI](../../../../../_images/admin-guide/how-to-guides/monitoring-install-redirects-to-grafana-1.png)

Fig. 3. Button demonstration in the cluster’s internal UI.

![Grafana UI](../../../../../_images/admin-guide/how-to-guides/monitoring-install-redirects-to-grafana-2.png)
