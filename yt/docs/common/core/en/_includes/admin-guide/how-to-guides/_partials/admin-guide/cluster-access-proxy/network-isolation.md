...
To enable the mode, add the `hostNetwork: true` field at the root level of the [operator]({{ docs_root }}/core/admin-guide/how-to-guides/install-ytsaurus#operator) specification:
