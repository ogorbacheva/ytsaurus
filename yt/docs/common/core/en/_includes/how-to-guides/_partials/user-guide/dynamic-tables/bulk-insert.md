...
{{product-name}} enables you to specify [sorted dynamic tables]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables) as output tables of map-reduce operations (the so-called bulk insert).
