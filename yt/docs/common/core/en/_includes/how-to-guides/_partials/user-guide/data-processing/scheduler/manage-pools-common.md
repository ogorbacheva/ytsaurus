...
* `create_ephemeral_subpools`: Allows creating [ephemeral pools]({{ docs_root }}/core/concepts/data-processing/scheduler/scheduler-and-pools#puly-i-derevya-pulov).
* `ephemeral_subpool_config`: A dictionary describing the configuration of virtual pools.

For more information about the listed attributes, see [Pool configuration]({{ docs_root }}/core/how-to-guides/data-processing/scheduler/pool-settings#pools).
