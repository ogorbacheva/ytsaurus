...
- Apply [delete tombstones]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables#udalenie-stroki) and physically delete rows.
- Delete old versions.
...
For more information about these attributes, see [Deleting old data]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables#remove_old_data).
