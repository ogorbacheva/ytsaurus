...
To enable the mode, add the `hostNetwork: true` field at the root level of the [operator]({{ docs_root }}/core/how-to-guides/install-ytsaurus#operator) specification:
