...
- [Solve the network isolation problem]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/network-isolation)—configure the cluster so that external clients can directly connect to cluster nodes for efficient reading and writing of large data volumes.

- [Split load between clients]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/manage-traffic)—isolate resources of different projects and split traffic into "light" (metadata, UI) and "heavy" (table reading and writing).
...
You can [split]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/manage-traffic) proxies into functional groups using roles. Typically, two main groups are distinguished:
...
- [How to solve the network isolation problem]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/network-isolation)
- [How to split load between clients]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/manage-traffic)
- [How to configure access for SPYT]({{ docs_root }}/admin-guide/cluster-access-proxy/spyt)
- [FAQ]({{ docs_root }}/core/how-to-guides/cluster-access-proxy/faq)
