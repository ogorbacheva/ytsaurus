...
Unlike other components, CHYT runs inside a {{product-name}} [vanilla operation]({{ docs_root }}/core/reference/data-processing/operations/vanilla), so certificates are passed in a specific way:
