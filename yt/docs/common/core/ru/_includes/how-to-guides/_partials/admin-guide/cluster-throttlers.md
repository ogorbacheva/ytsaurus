...
Cluster throttlers — это механизм квотирования входящего межкластерного трафика на MR-кластерах {{product-name}}. Квотирование затрагивает операции [RemoteCopy]({{ docs_root }}/core/reference/data-processing/operations/remote-copy) и операции MapReduce с удалённым чтением входных таблиц.

Подробнее о том, как квотирование влияет на операции пользователей, см. в разделе [Квотирование межкластерной сетевой полосы]({{ docs_root }}/core/reference/data-processing/operations/cluster-throttlers).
