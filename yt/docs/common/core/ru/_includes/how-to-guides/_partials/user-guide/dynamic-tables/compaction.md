...
- применения [delete tombstones]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables#udalenie-stroki) и физического удаления строк;
...
Подробно эти атрибуты описаны в разделе [Удаление старых данных]({{ docs_root }}/core/concepts/dynamic-tables/sorted-dynamic-tables#remove_old_data).
