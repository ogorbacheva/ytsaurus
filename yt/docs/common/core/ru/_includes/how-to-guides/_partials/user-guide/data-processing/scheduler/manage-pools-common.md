...
* `create_ephemeral_subpools` — разрешение создавать [эфемерные пулы]({{ docs_root }}/core/concepts/data-processing/scheduler/scheduler-and-pools#puly-i-derevya-pulov);
* `ephemeral_subpool_config` — словарь, описывающий конфигурацию виртуальных пулов.

Подробное описание указанных атрибутов см. в разделе [Конфигурация пула]({{ docs_root }}/core/how-to-guides/data-processing/scheduler/pool-settings#pools).
