...
- В SDK на других языках
  ...
  Можно передать настройку `stderr_table_path` напрямую в спецификацию операции. Описание данной опции см. в разделе [Настройки операций]({{ docs_root }}/core/reference/data-processing/operations/operations-options).
