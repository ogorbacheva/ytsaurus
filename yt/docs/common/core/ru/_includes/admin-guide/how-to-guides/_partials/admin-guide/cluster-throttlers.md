...
Cluster throttlers — это механизм квотирования входящего межкластерного трафика на MR-кластерах {{product-name}}. Квотирование затрагивает операции [RemoteCopy]({{ docs_root }}/core/user-guide/reference/data-processing/operations/remote-copy) и операции MapReduce с удалённым чтением входных таблиц.

Подробнее о том, как квотирование влияет на операции пользователей, см. в разделе [Квотирование межкластерной сетевой полосы]({{ docs_root }}/core/user-guide/reference/data-processing/operations/cluster-throttlers).
...
{{ core-admin-guide-how-to-guides-cluster-throttlers-md-audience-1 }}
...
{{ core-admin-guide-how-to-guides-cluster-throttlers-md-audience-2 }}
