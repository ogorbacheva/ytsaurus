...
{{ core-admin-guide-how-to-guides-install-excel-md-audience-1 }}
...
3. Убедитесь, что вкладка `Excel` отображается:
   ...
   ![Вкладка экспорта Excel в UI](../../../../../_images/admin-guide/how-to-guides/install_excel_01_excel_tab.png)
