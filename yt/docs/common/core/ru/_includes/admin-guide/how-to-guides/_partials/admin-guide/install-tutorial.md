...
* специальный пользователь с выписанным для него токеном (см. раздел [Управление токенами]({{ docs_root }}/core/user-guide/reference/storage/auth#token-management));
