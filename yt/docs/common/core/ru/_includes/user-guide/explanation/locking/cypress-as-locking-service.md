...
{% include [Распределённые блокировки](../_partials/user-guide/locking/cypress-as-locking-service-p1.md) %}
...
{% include [Распределённые блокировки](../_partials/user-guide/locking/cypress-as-locking-service-p2.md) %}

## Квотирование

{% include [Распределённые блокировки](../_partials/user-guide/locking/cypress-as-locking-service-p3.md) %}
