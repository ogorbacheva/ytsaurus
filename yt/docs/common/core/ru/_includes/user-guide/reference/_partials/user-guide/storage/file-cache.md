...
Файловый кеш позволяет однократно загрузить файл в [Кипарис]({{ docs_root }}/core/user-guide/explanation/storage/cypress), а затем получать путь к файлу на кластере по заданному [MD5 хешу](https://ru.wikipedia.org/wiki/MD5). 
...
## Подсчёт MD5 хеша у загружаемых файлов { #compute_md5 }
