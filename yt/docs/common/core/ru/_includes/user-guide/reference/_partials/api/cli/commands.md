...
> `source_path`    source address, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `destination_path`    destination address, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

#### Named Arguments

> `--params`    specify additional params. structured params in yson format

> `--source-path`    source address, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `--destination-path`    destination address, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--format`    response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats), default: `«<format=pretty>yson»`
...
> `target_path`    address of original node to link, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `link_path`    address of resulting link, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

#### Named Arguments

> `--params`    specify additional params. structured params in yson format

> `--target-path`    address of original node to link, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `--link-path`    address of resulting link, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--format`    response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
> `source_path`    old node address, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `destination_path`    new node address, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

#### Named Arguments

> `--params`    specify additional params. structured params in yson format

> `--source-path`    old node address, path must exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `--destination-path`    new node address, path must not exist. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--format`    response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats), default: `«yson»`
...
> `destination`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--path`    path where temporary table will be created. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--path`    (Required) Path to source table. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath) Accepted multiple times.
...
> `table`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--format`    output format. (yson string), one of «yson», «json», «yamr», «dsv», «yamred_dsv», «schemaful_dsv» with modifications. See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
> `--format`    input format. (yson string), one of «yson», «json», «yamr», «dsv», «yamred_dsv», «schemaful_dsv» with modifications. See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
> `path`    path to dynamic table. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `table`    path to table to erase. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--format`    (yson string), one of «yson», «json», «yamr», «dsv», «yamred_dsv», «schemaful_dsv» with modifications. See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
> `--dst`    (Required) path to destination table. For append mode add <append=true> before path. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `consumer_path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `queue_path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

#### Named Arguments

> `--params`    specify additional params. structured params in yson format

> `--consumer-path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `--queue-path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--producer-path`    Path to producer in Cypress; cluster may be specified. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

> `--queue-path`    Path to queue in Cypress; cluster may be specified. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--consumer-path`    Path to consumer in Cypress; cluster may be specified. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `producer_path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--producer-path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--input-format`    input format. (yson string), one of «yson», «json», «yamr», «dsv», «yamred_dsv», «schemaful_dsv» with modifications. See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)

> `--output-format`    output format. response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
> `pipeline_path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)

###### Named Arguments

> `--pipeline-path`    address in Cypress. See also: [YPATH]({{ docs_root }}/core/user-guide/reference/storage/ypath)
...
> `--input-format`    response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)

> `--output-format`    response or input format: yson or json, for example: «<format=binary>yson». See also: [Formats]({{ docs_root }}/core/user-guide/reference/storage/formats)
...
{{ core-user-guide-reference-api-cli-commands-md-audience-1 }}
...
{{ core-user-guide-reference-api-cli-commands-md-audience-2 }}
