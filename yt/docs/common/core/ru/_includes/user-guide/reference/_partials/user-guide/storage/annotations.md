...
В данном разделе описываются аннотации таблиц, директорий и других узлов [Кипариса]({{ docs_root }}/core/user-guide/explanation/storage/cypress).
...
У всех узлов Кипариса имеется атрибут `annotation`, значением которого является [YSON string]({{ docs_root }}/core/user-guide/reference/storage/yson). Значение можно задать, как и для других атрибутов:
