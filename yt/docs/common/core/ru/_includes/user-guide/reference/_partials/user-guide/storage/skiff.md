...
Skiff (от schemaful format) — один из [форматов]({{ docs_root }}/core/user-guide/reference/storage/formats) передачи схематизированных данных между job_proxy и джобом.
