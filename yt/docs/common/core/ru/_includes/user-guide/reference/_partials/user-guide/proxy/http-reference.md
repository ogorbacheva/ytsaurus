...
- информацию о входном и выходном [формате]({{ docs_root }}/core/user-guide/reference/storage/formats) данных (представлена в виде YSON-строки с атрибутами);
...
HTTP API является версионированным (как можно заметить из наличия префикса `/v4` в примерах [отсюда]({{ docs_root }}/core/user-guide/reference/proxy/http)). Версия API изменяется при обратно-несовместимых изменениях множества поддерживаемых команд или семантики какой-либо из существующих команд. Добавление новых команд обычно не приводит к смене версии API. В HTTP-прокси осуществляется поддержка двух последних версий API.
...
| -------------------------------------------------------- | ------------------ | ------------------- | --------------- | ------------ | ---------------- | -------------- |
| [start_tx]({{ docs_root }}/core/user-guide/reference/api/commands#starttx)                |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [ping_tx]({{ docs_root }}/core/user-guide/reference/api/commands#pingtx)                  |                    |                     | Да              | Нет          | Нет              | POST           |
| [commit_tx]({{ docs_root }}/core/user-guide/reference/api/commands#committx)              |                    |                     | Да              | Нет          | Да               | POST           |
| [abort_tx]({{ docs_root }}/core/user-guide/reference/api/commands#aborttx)                |                    |                     | Да              | Нет          | Да               | POST           |
| [create]({{ docs_root }}/core/user-guide/reference/api/commands#create)                   |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [remove]({{ docs_root }}/core/user-guide/reference/api/commands#remove)                   |                    |                     | Да              | Нет          | Да               | POST           |
| [set]({{ docs_root }}/core/user-guide/reference/api/commands#set)                         | Структурированные  |                     | Да              | Нет          | Да               | PUT            |
| [get]({{ docs_root }}/core/user-guide/reference/api/commands#get)                         |                    | Структурированные   | Нет             | Нет          | Нет              | GET            |
| [list]({{ docs_root }}/core/user-guide/reference/api/commands#list)                       |                    | Структурированные   | Нет             | Нет          | Нет              | GET            |
| [lock]({{ docs_root }}/core/user-guide/reference/api/commands#lock)                       |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [copy]({{ docs_root }}/core/user-guide/reference/api/commands#copy)                       |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [move]({{ docs_root }}/core/user-guide/reference/api/commands#move)                       |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [link]({{ docs_root }}/core/user-guide/reference/api/commands#link)                       |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [exists]({{ docs_root }}/core/user-guide/reference/api/commands#exists)                   |                    | Структурированные   | Нет             | Нет          | Нет              | GET            |
| [write_file]({{ docs_root }}/core/user-guide/reference/api/commands#writefile)            | Бинарные           | Структурированные   | Да              | Да           | Нет              | PUT            |
| [read_file]({{ docs_root }}/core/user-guide/reference/api/commands#readfile)              |                    | Бинарные            | Нет             | Да           | Нет              | GET            |
| [write_table]({{ docs_root }}/core/user-guide/reference/api/commands#writetable)          | Табличные          |                     | Да              | Да           | Нет              | PUT            |
| [read_table]({{ docs_root }}/core/user-guide/reference/api/commands#readtable)            |                    | Табличные           | Нет             | Да           | Нет              | GET            |
| [write_journal]({{ docs_root }}/core/user-guide/reference/api/commands#writejournal)      | Табличные          |                     | Да              | Да           | Нет              | PUT            |
| [read_journal]({{ docs_root }}/core/user-guide/reference/api/commands#readjournal)        |                    | Табличные           | Нет             | Да           | Нет              | GET            |
| [select_rows]({{ docs_root }}/core/user-guide/reference/api/commands#select_rows) (0.17+) |                    | Табличные           | Нет             | Да           | Нет              | GET            |
| [merge]({{ docs_root }}/core/user-guide/reference/api/commands#merge)                     |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [erase]({{ docs_root }}/core/user-guide/reference/api/commands#erase)                     |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [map]({{ docs_root }}/core/user-guide/reference/api/commands#map)                         |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [reduce]({{ docs_root }}/core/user-guide/reference/api/commands#reduce)                   |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [map_reduce]({{ docs_root }}/core/user-guide/reference/api/commands#map_reduce)           |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [sort]({{ docs_root }}/core/user-guide/reference/api/commands#sort)                       |                    | Структурированные   | Да              | Нет          | Да               | POST           |
| [abort_op]({{ docs_root }}/core/user-guide/reference/api/commands#abortop)                |                    |                     | Да              | Нет          | Нет              | POST           |
