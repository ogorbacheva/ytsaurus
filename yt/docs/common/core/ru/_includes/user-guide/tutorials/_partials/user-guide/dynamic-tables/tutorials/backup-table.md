...
- MapReduce
  ...
  Если требуется дать доступ на чтение и на запись данных при копировании таблицы, сделайте дамп содержимого динамической таблицы в статическую и обратно. Для этого используйте скрипт, описанный в разделе [MapReduce по динамическим таблицам]({{ docs_root }}/core/user-guide/how-to-guides/dynamic-tables/mapreduce).
