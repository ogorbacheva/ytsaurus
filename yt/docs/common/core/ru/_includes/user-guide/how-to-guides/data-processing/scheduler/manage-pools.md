{% include [Управление пулами: Общие сведения](../../_partials/user-guide/data-processing/scheduler/manage-pools-common.md) %}
...
### Перечень допустимых действий с вычислительным пулом { #allowed_pool_actions }
...
- Для управления операциями в данном пуле и его потомках необходимо право `manage` (под управлением операциями скрывается возможность выполнять операции `suspend`, `resume` и `update_operation_parameters`, не являясь автором операции).
...
{% include [Управление пулами: Управление пулами через CLI](../../_partials/user-guide/data-processing/scheduler/manage-pools-cli.md) %}
