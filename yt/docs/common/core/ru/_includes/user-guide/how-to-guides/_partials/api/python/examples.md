...
Перед запуском примеров рекомендуется прочитать [инструкцию]({{ docs_root }}/core/user-guide/reference/storage/auth) по получению токена.
...
Данные, хранящиеся в таблицах и обрабатываемые операциями, представляются в коде [классами]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#dataclass) с типизированными полями (аналог [dataclasses](https://docs.python.org/3/library/dataclasses.html)). Нерекомендуемый (но иногда неизбежный, особенно при работе со старыми таблицами) способ — нетипизированный, когда строки таблиц представляются словарями.
...
У всех таблиц в {{product-name}} есть [схема]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#table_schema).
...
Примеры декораторов: `with_context`, `aggregator`, `reduce_aggregator`, `raw`, `raw_io`. Полное описание можно найти в [документации]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#python_decorators)
...
Более полная информация в [документации]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#file_commands).
...
В данном примере более подробно продемонстрированы возможности и особенности работы с [датаклассами]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#dataclass).
...
Используйте [spec builder]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#spec_builder) для описания спецификации операций чтобы избегать ошибок.
...
Документация содержится [в отдельном разделе]({{ docs_root }}/core/user-guide/how-to-guides/api/python/userdoc#gevent).
