...
* Шардирование таблиц.
* Перераспределение таблетов между [таблет-селлами]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/concepts#tablet_cells).
...
Балансировку можно настраивать как потаблично, так и для каждого [таблет-селл бандла]({{ docs_root }}/core/user-guide/explanation/dynamic-tables/concepts#tablet_cell_bundles). Также балансировку можно настраивать для групп таблиц. Конфигурация на таблице приоритетнее конфигурации группы, которая, в свою очередь, приоритетнее конфигурации бандла.

В системе есть два вида балансировщиков: legacy, живущий в процессе мастера и поддерживающий только балансировку по размерам таблетов и ограниченное число опций, и выделенный, в котором доступна также балансировка по нагрузке. {{ core-user-guide-how-to-guides-dynamic-tables-tablet-balancing-md-audience-1 }}
