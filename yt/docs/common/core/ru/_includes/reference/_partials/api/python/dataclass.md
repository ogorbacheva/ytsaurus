...
## Мотивация { #motivation }
  ...
  3. Скорость: за счёт использования формата [Skiff]({{ docs_root }}/core/reference/storage/skiff) и некоторых других оптимизаций потребление CPU в несколько раз меньше, чем для нетипизированных данных.
...
Имея такой класс, можно:
  ...
  2. Писать и читать [таблицы]({{ docs_root }}/core/how-to-guides/api/python/userdoc#table_commands), [пример]({{ docs_root }}/core/how-to-guides/api/python/examples#read_write).
  3. Запускать [операции]({{ docs_root }}/core/how-to-guides/api/python/userdoc#python_operations), [пример]({{ docs_root }}/core/how-to-guides/api/python/examples#simple_map).
