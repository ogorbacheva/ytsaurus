...
- В качестве хранилища будут использоваться [реплицированные динамические таблицы]({{ docs_root }}/core/concepts/dynamic-tables/replicated-dynamic-tables) {{product-name}} в режиме синхронной репликации. Работа с динамическими таблицами реализована через RPC прокси.
