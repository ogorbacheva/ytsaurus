...
Подробнее об очистке и о делении упорядоченных динамических таблиц на таблеты можно прочитать в разделе [Упорядоченные динамические таблицы]({{ docs_root }}/core/concepts/dynamic-tables/ordered-dynamic-tables).
