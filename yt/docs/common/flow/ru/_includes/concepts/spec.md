...
Спека &mdash; основной способ описания желаемого [пайплайна]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#pipeline). Любой высокоуровневый API к Flow генерирует спеку пайплайна.
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TPipelineSpec.md) %}

### Computation

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TComputationSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TWatermarkStrategySpec.md) %}

##### EventTimestampAssigner {#event-timestamp-assigner}

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TEventTimestampAssignerSpec.md) %}

##### WatermarkGenerator {#watermark-generator}

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TWatermarkGeneratorSpec.md) %}

Настройки `IdlePartitions`:

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TIdlePartitionsSpec.md) %}

Настройки `UnavailablePartitionGroups`:

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TUnavailablePartitionGroupsSpec.md) %}

##### WatermarkAlignment {#watermark-alignment}

Модуль используется для выравнивания входных [потоков]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#stream-and-computation). Может приводить к полной остановке чтения в случае проблем с доступностью и/или оценкой `Watermark` у отдельных [партиций]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#partition) или `SourceComputation`.

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TWatermarkAlignmentSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TWatermarkPercentileSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TLateDataPartitionsSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TSourceSpec.md) %}

Встроенные реализации [сорсов]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#source) описаны в [документации по коннекторам]({{ flow-docs-root }}/{{ lang }}/concepts/connectors/overview{{ docs-revision-query }}).

#### Sink {#sink_spec}

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TSinkSpec.md) %}

Встроенные реализации [синков]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#sink) описаны в [документации по коннекторам]({{ flow-docs-root }}/{{ lang }}/concepts/connectors/overview{{ docs-revision-query }}).

#### HeavyHitters

Модуль обнаружения высокочастотных ключей.

{% include notitle [_](../../../reference/configuration/NYT_NFlow_THeavyHittersSpec.md) %}

#### InputOrdering

Настройки порядка обработки событий из входных потоков. Первыми будут обработаны события с наименьшим временем.

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TInputOrderingSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TStreamSpec.md) %}

### Resource

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TResourceSpec.md) %}

## DynamicSpec

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicPipelineSpec.md) %}

`Stream` и `Resource` в данный момент не имеют или не поддерживают динамические параметры.

### Computation

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicComputationSpec.md) %}

#### Source

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicSourceSpec.md) %}

#### Sink

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicSinkSpec.md) %}

### JobManager

Конфиг модуля управления [джобами]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#job) на [контроллере]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#controller).

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicJobManagerSpec.md) %}

### JobTracker

Конфиг модуля управления джобами на [воркере]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#worker).

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicJobTrackerSpec.md) %}

#### BufferStateManager

Конфиг модуля управления размерами буферов.

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicBufferStateManagerSpec.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicControllerConnectorSpec.md) %}
...
В конкретных реализациях сущностей поле `parameters` парсится в [yson struct]({{ core-docs-root }}/{{ lang }}/reference/storage/data-types{{ docs-revision-query }}#yson_struct) для удобства и эффективности. При этом классы, в которые парсится поле `parameters`, называются `T*Parameters`, а не `T*Spec`. Как это работает на примере статической спеки `Computation`:
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TFlowNodeConfig.md) %}

### Controller

{% include notitle [_](../../../reference/configuration/NYT_NFlow_NController_TControllerConfig.md) %}

#### PersistedStateManager

{% include notitle [_](../../../reference/configuration/NYT_NFlow_NController_TPersistedStateManagerConfig.md) %}

#### LeaseManager

{% include notitle [_](../../../reference/configuration/NYT_NFlow_NController_TLeaseManagerConfig.md) %}

#### ControllerService

{% include notitle [_](../../../reference/configuration/NYT_NFlow_NController_TControllerServiceConfig.md) %}
...
{% include notitle [_](../../../reference/configuration/NYT_NFlow_TSimpleRunnerConfig.md) %}

## См. также

- [Computation]({{ flow-docs-root }}/{{ lang }}/concepts/computation{{ docs-revision-query }})
- [Watermarks и Timers]({{ flow-docs-root }}/{{ lang }}/concepts/watermarks{{ docs-revision-query }})
