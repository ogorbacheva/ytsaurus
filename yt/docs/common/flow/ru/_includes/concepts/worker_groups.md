...
Worker Groups &mdash; это механизм группировки [воркеров]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#worker) и привязки [компьютейшенов]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#stream-and-computation) к определённым группам воркеров. Это позволяет:
...
Компьютейшены привязываются к группе воркеров через параметр [спеки]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#spec-and-dynamic-spec) `worker_group`.
...
По умолчанию все группы воркеров используют общие настройки балансера, определённые в секции `job_manager` динамической спеки [пайплайна]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#pipeline):
...
- Значение: настройки балансера (все параметры из [`TDynamicJobBalancerSpec`]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager)).

Полное описание параметров см. в [документации по JobManager]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager).
...
- [Основные понятия YT Flow]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }})
- [Спецификация пайплайна]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }})
- [Балансировка нагрузки]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager)
