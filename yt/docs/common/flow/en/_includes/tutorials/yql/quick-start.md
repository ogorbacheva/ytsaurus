...
Use YQL over Flow to describe a [pipeline]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#pipeline) for streaming data processing as a declarative SQL query — without writing code in [C++]({{ flow-docs-root }}/{{ lang }}/tutorials/cpp/quick-start{{ docs-revision-query }}), [Java]({{ flow-docs-root }}/{{ lang }}/tutorials/java/quick-start{{ docs-revision-query }}), or [Python]({{ flow-docs-root }}/{{ lang }}/tutorials/python/quick-start{{ docs-revision-query }}). The pipeline runs as a vanilla operation on the selected {{product-name}} cluster.
...
- [YQL documentation]({{ yql-docs-root }}/{{ lang }}/yql/{{ docs-revision-query }}) — complete reference for YQL syntax
...
Example: row-by-row transformation of a [stream]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#stream-and-computation) (map).
...
For a description of all supported YQL constructs, see the [Supported constructs]({{ flow-docs-root }}/{{ lang }}/reference/yql/features{{ docs-revision-query }}) section.
...
- [Supported constructs]({{ flow-docs-root }}/{{ lang }}/reference/yql/features{{ docs-revision-query }})
