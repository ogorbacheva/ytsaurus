...
- [Similar example in C++]({{ flow-docs-root }}/{{ lang }}/tutorials/cpp/examples/url_downloader{{ docs-revision-query }})
- [Similar example in Java]({{ flow-docs-root }}/{{ lang }}/tutorials/java/examples/url_downloader{{ docs-revision-query }})