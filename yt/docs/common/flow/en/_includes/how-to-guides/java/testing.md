...
This is a complete unit test example for `JoinProcessFunction` from the [wait_click_join]({{ flow-docs-root }}/{{ lang }}/tutorials/java/examples/wait_click_join{{ docs-revision-query }}) project. In this variant, you create `PipelineContext` manually, without a Spring container.
