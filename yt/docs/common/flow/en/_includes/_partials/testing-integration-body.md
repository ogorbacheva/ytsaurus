...
If something isn’t working, check errors in all these logs. The approach to reviewing them is the same as in production — see [Logs]({{ flow-docs-root }}/{{ lang }}/how-to-guides/operations/view-logs{{ docs-revision-query }}).
