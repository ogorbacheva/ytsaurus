...
Worker Groups are a mechanism for grouping [workers]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#worker) and binding [computations]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#stream-and-computation) to specific worker groups. This lets you:
...
You bind computations to a worker group using the `worker_group` parameter in the [spec]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#spec-and-dynamic-spec).
...
By default, all worker groups use the common balancer settings defined in the `job_manager` section of the pipeline’s dynamic [spec]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#pipeline):
...
- Value: balancer settings (all parameters from [`TDynamicJobBalancerSpec`]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager)).

For a full description of the parameters, see the [JobManager documentation]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager).
...
- [YT Flow core concepts]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }})
- [Pipeline spec]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }})
- [Load balancing]({{ flow-docs-root }}/{{ lang }}/concepts/spec{{ docs-revision-query }}#jobmanager)