...
Use this module to align input [streams]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#stream-and-computation). It can cause a complete read stop if there are availability issues or problems estimating the `Watermark` for individual [partitions]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#partition) or `SourceComputation`.
...
Built-in [source]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#source) implementations are described in the [connector documentation]({{ flow-docs-root }}/{{ lang }}/concepts/connectors/overview{{ docs-revision-query }}).

#### Sink {#sink_spec}

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TSinkSpec.md) %}

Built-in [sink]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#sink) implementations are described in the [connector documentation]({{ flow-docs-root }}/{{ lang }}/concepts/connectors/overview{{ docs-revision-query }}).
...
This is the config for the module that manages [jobs]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#job) on the [controller]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#controller).

{% include notitle [_](../../../reference/configuration/NYT_NFlow_TDynamicJobManagerSpec.md) %}

### JobTracker

This is the config for the module that manages jobs on the [worker]({{ flow-docs-root }}/{{ lang }}/concepts/glossary{{ docs-revision-query }}#worker).
