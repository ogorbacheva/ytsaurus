...
At [cluster startup]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#standalone), each worker will be allocated an integer number of GPUs specified in the `--worker-gpu-limit` option:
