...
In transactional mode, data writing and consumer offset committing are combined into a single tablet transaction. This eliminates duplicates when re‑executing a micro‑batch. Unlike the [idempotent receiver]({{ docs_root }}/spyt/user-guide/how-to-guides/structured-streaming/idempotent-receiver.md), this approach works with any transformations, including shuffle (`join`, aggregations).
...
- [Idempotent receiver]({{ docs_root }}/spyt/user-guide/how-to-guides/structured-streaming/idempotent-receiver.md) — alternative for stateless 1:1 transformations
- [Streaming options]({{ docs_root }}/spyt/user-guide/reference/streaming-options.md) — options reference
- [Configuration parameters]({{ docs_root }}/spyt/user-guide/reference/configuration.md) — Spark session parameters
