...
2.  **Find the service address.**
    ...
    - Row 1 (`master`): UI of the master node of a [standalone]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md) cluster.
    - Row 2 (`history`): UI of the history server.
    - Row 3 (`driver`): UI of the driver when launched via [direct submit]({{ docs_root }}/spyt/user-guide/explanation/direct-submit.md).
