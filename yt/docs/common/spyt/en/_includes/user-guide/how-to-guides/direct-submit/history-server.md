...
The main parameters of the `shs-launch-yt` command are a subset of the parameters of the [spark-launch-yt]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md#spark-launch-yt-params) command that are relevant for launching the History Server. Example of launching the History Server:
