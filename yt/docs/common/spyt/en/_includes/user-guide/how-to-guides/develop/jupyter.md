...
Before you can use Spark in Jupyter, you need to create a [cluster]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md). Currently working with Spark using Jupyter notebooks is possible only using inner standalone cluster.
