...
Reading from a [transaction]({{ core-docs-root }}/{{ lang }}/user-guide/explanation/storage/transactions{{ docs-revision-query }}). For more details, see [Reading and writing within a transaction]({{ docs_root }}/spyt/user-guide/how-to-guides/read-write-in-transaction.md).
...
Read tables with schema in [type_v3]({{ core-docs-root }}/{{ lang }}/user-guide/reference/storage/data-types{{ docs-revision-query }}) instead of type_v1. It can be enabled in [Spark configuration]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/configure.md) or write option.
