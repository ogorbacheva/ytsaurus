...
Write tables with schema in [type_v3]({{ core-docs-root }}/{{ lang }}/user-guide/reference/storage/data-types{{ docs-revision-query }}) instead of type_v1. It can be enabled via [Spark configuration]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/configure.md) or write option.
