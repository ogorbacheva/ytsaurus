...
This section lists SPYT options for Structured Streaming, service columns, and a version compatibility matrix. Spark session parameters (including `spark.yt.streaming.transactional`) are available on the [Configuration parameters]({{ docs_root }}/spyt/user-guide/reference/configuration.md) page.
...
- [Structured Streaming]({{ docs_root }}/spyt/user-guide/explanation/structured-streaming.md) — overview and main scenarios
- [Exactly‑once guarantee]({{ docs_root }}/spyt/user-guide/explanation/structured-streaming/exactly-once.md) — choosing an approach to guarantees
- [Transactional mode]({{ docs_root }}/spyt/user-guide/how-to-guides/structured-streaming/transactional-mode.md) — instructions for enabling exactly‑once
- [Configuration parameters]({{ docs_root }}/spyt/user-guide/reference/configuration.md) — Spark session parameters, including `spark.yt.streaming.transactional` and `spark.yt.write.dynBatchSize`
