...
The launch of Spark applications in direct submit mode is described in a separate [section]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#submit).
...
![](../../../_images/user-guide/explanation/spyt-direct-submit-operation-concept.png){ .center }
...
You can find information on building your own Docker image in the [cluster configuration section]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/configure.md#build-image).
