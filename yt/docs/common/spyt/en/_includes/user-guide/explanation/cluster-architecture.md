...
Cluster start is described in a separate [section]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md).
...
![](../../../_images/user-guide/explanation/cluster_structure.png){ .center }
...
There are two methods for launching Spark applications in the current implementation: [submitting directly using {{product-name}} scheduler]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#submit) or deploying an inner Spark standalone cluster using Vanilla operation.
...
![](../../../_images/user-guide/explanation/cluster_scheme.png){ .center }
...
![](../../../_images/user-guide/explanation/cluster_scheme_cyp.png){ .center }
...
![](../../../_images/user-guide/explanation/cluster_mode.png){ .center }
