...
The launch of Spark applications in direct submit mode is described in a separate [section]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/run-spark-jobs{{ docs-revision-query }}#submit).
...
You can find information on building your own Docker image in the [cluster configuration section]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/configure{{ docs-revision-query }}#build-image).
