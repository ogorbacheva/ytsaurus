...
Cluster start is described in a separate [section]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/start{{ docs-revision-query }}).
...
![](../../../_images/spyt-cluster-structure.png){ .center }
...
There are two methods for launching Spark applications in the current implementation: [submitting directly using {{product-name}} scheduler]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/run-spark-jobs{{ docs-revision-query }}#submit) or deploying an inner Spark standalone cluster using Vanilla operation.
...
![](../../../_images/spyt-cluster-scheme.png){ .center }
...
![](../../../_images/spyt-cluster-scheme-cypress.png){ .center }
...
![](../../../_images/spyt-cluster-mode.png){ .center }
