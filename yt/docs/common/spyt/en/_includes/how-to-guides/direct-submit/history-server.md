...
The main parameters of the `shs-launch-yt` command are a subset of the parameters of the [spark-launch-yt]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/start{{ docs-revision-query }}#spark-launch-yt-params) command that are relevant for launching the History Server. Example of launching the History Server:
...
{% include [shs warning](../../_partials/history-server-disclaimer.md) %}
