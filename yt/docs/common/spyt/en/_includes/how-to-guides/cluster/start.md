...
| `--worker-disk-name` | no | default | Name of the disk requested in the operation specification. For more information, see [Disk requests for jobs]({{ core-docs-root }}/{{ lang }}/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request). | - |
| `--worker-disk-limit` | no | - | Maximum disk capacity requested in the operation specification. For more information, see [Disk requests for jobs]({{ core-docs-root }}/{{ lang }}/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request). | - |
| `--worker-disk-account` | no | - | [Account]({{ core-docs-root }}/{{ lang }}/reference/storage/accounts{{ docs-revision-query }}) for requesting a disk in the operation specification. For more information, see [Disk requests for jobs]({{ core-docs-root }}/{{ lang }}/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request). | - |
...
| `--ssd-account` | no | - | {{product-name}} [account]({{ core-docs-root }}/{{ lang }}/reference/storage/accounts{{ docs-revision-query }}) used for SSD allocation. | - |
