...
Запуск Spark приложений в режиме прямого сабмита описан в отдельном [разделе]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#submit).
...
Информацию о сборке собственного Docker-образа можно найти в [разделе про конфигурирование кластера]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/configure.md#build-image).
