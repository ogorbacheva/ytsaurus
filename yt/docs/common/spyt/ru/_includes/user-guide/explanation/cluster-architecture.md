...
Запуск кластера описан в отдельном [разделе]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md).
...
В текущей реализации есть два варианта запуска Spark задач: [с использованием планировщика {{product-name}}]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#submit), либо с использованием внутреннего Spark Standalone кластера, который разворачивается внутри Vanilla операции.
