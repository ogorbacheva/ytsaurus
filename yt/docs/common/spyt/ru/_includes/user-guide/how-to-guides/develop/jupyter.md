...
Перед тем как использовать Spark в Jupyter, необходимо создать [кластер]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md). Работа со Spark из Jupyter ноутбуков в настоящий момент возможна только с использованием standalone кластера.
