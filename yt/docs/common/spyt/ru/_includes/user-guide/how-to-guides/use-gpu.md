...
При [старте кластера]({{ docs_root }}/spyt/user-guide/how-to-guides/run-spark-jobs.md#standalone) каждому воркеру будет выделено целое количество GPU, указанное в опции `--worker-gpu-limit`:
