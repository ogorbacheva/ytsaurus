...
2.  **Найдите адрес сервиса**.
    ...
    *   **Строка 1 (`master`)**: UI мастер-ноды [standalone]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md) кластера.
    *   **Строка 2 (`history`)**: UI сервера истории (History Server).
    *   **Строка 3 (`driver`)**: UI драйвера при запуске через [direct submit]({{ docs_root }}/spyt/user-guide/explanation/direct-submit.md).
