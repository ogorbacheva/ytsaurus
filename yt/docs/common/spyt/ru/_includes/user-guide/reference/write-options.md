...
Запись таблиц со схемой в формате [type_v3]({{ core-docs-root }}/{{ lang }}/user-guide/reference/storage/data-types{{ docs-revision-query }}) вместо `type_v1`. Настраивается в [Spark конфигурации]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/configure.md) или опции записи.
