...
Для запуска Livy сервера можно использовать команду `livy-launch-yt`, входящую в дистрибутив SPYT. Её основные параметры повторяют параметры команды [spark-launch-yt]({{ docs_root }}/spyt/user-guide/how-to-guides/cluster/start.md#spark-launch-yt-params) с небольшими отличиями, приведёнными в таблице:
