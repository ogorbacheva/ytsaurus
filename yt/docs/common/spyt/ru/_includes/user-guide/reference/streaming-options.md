...
В разделе перечислены опции SPYT для Structured Streaming, служебные колонки и матрица совместимости версий. Параметры Spark-сессии (включая `spark.yt.streaming.transactional`) — на странице [Конфигурационные параметры]({{ docs_root }}/spyt/user-guide/reference/configuration.md).
...
- [Structured Streaming]({{ docs_root }}/spyt/user-guide/explanation/structured-streaming.md) — обзор и основные сценарии
- [Гарантия exactly-once]({{ docs_root }}/spyt/user-guide/explanation/structured-streaming/exactly-once.md) — выбор подхода к гарантиям
- [Транзакционный режим]({{ docs_root }}/spyt/user-guide/how-to-guides/structured-streaming/transactional-mode.md) — инструкция по включению exactly-once
- [Конфигурационные параметры]({{ docs_root }}/spyt/user-guide/reference/configuration.md) — параметры Spark-сессии, включая `spark.yt.streaming.transactional` и `spark.yt.write.dynBatchSize`
