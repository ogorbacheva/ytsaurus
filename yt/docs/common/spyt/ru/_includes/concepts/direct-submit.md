...
Запуск Spark приложений в режиме прямого сабмита описан в отдельном [разделе]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/run-spark-jobs{{ docs-revision-query }}#submit).
...
Информацию о сборке собственного Docker-образа можно найти в [разделе про конфигурирование кластера]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/configure{{ docs-revision-query }}#build-image).
