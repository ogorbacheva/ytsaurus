...
Перед обновлением проверьте совместимость версий SPYT, Spark, Java, Scala и Python {% if audience == "public" %}в [таблице совместимости]({{ spyt-docs-root }}/{{ lang }}/concepts/index{{ docs-revision-query }}#spyt-compatibility).{% endif %}


{% if audience == "public" %}Доступные версии SPYT и изменения в них описаны в [релизах SPYT]({{ spyt-docs-root }}/{{ lang }}/reference/release-notes{{ docs-revision-query }}#spyt).{% endif %}
