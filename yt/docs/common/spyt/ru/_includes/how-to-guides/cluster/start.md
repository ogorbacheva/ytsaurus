...
| `--params` | нет | - | Дополнительные параметры {{product-name}} операции, указываются в виде YSON строки. Подробнее - на странице [конфигурации]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/configure{{ docs-revision-query }}#add) | - |
...
| `--enable-ytsaurus-shuffle`, `--disable-ytsaurus-shuffle` | нет | `--disable-ytsaurus-shuffle` | Использовать [{{product-name}} Shuffle сервис]({{ spyt-docs-root }}/{{ lang }}/concepts/ytsaurus-shuffle-service{{ docs-revision-query }}) | 2.7.2 |
| `--enable-spark-shuffle`, `--disable-spark-shuffle` | нет | `--enable-spark-shuffle` | Запускать нативный внешний Spark shuffle service на кластере (см. [Shuffle сервис]({{ spyt-docs-root }}/{{ lang }}/concepts/ytsaurus-shuffle-service{{ docs-revision-query }}#enabling-standalone)) | 2.9.3 |
...
| `--worker-disk-name` | нет | default | Название диска для заказа в спецификации операции, подробнее в разделе [заказ диска в джобах]({{ core-docs-root }}/{{ lang }}/user-guide/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request) | - |
| `--worker-disk-limit` | нет | - | Максимальный объём диска при заказе в спецификации операции, подробнее в разделе [заказ диска в джобах]({{ core-docs-root }}/{{ lang }}/user-guide/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request) | - |
| `--worker-disk-account` | нет | - | [Аккаунт]({{ core-docs-root }}/{{ lang }}/user-guide/reference/storage/accounts{{ docs-revision-query }}), используемый при заказе диска в спецификации операции, подробнее в разделе [заказ диска в джобах]({{ core-docs-root }}/{{ lang }}/user-guide/reference/data-processing/operations/operations-options{{ docs-revision-query }}#disk_request) | - |
...
| `--ssd-account` | нет | - | {{product-name}} [Аккаунт]({{ core-docs-root }}/{{ lang }}/user-guide/reference/storage/accounts{{ docs-revision-query }}), используемый для выделения SSD | - |
...
| `--autoscaler-period`, `--autoscaler-metrics-port`, `--autoscaler-sliding-window`, `--autoscaler-max-free-workers`, `--autoscaler-slot-increment-step` | нет | - | Параметры, используемые для работы с [автоскейлером]({{ spyt-docs-root }}/{{ lang }}/how-to-guides/cluster/start{{ docs-revision-query }}#auto-scale) | - |
| `--enable-livy` | нет | false | Запустить Livy сервер в составе кластера. Подробнее про Livy сервер описано [на соответвтвующей странице]({{ spyt-docs-root }}/{{ lang }}/reference/livy{{ docs-revision-query }}) | 1.74.0 |
