...
Поддерживаются те же три режима, что и в [TReadStatesArg]({{ flow-docs-root }}/{{ lang }}/reference/configuration/all_yson_structs{{ docs-revision-query }}#NYT_NFlow_TReadStatesArg).
