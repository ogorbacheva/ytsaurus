...
The same three modes as in [TReadStatesArg]({{ flow-docs-root }}/{{ lang }}/reference/configuration/all_yson_structs{{ docs-revision-query }}#NYT_NFlow_TReadStatesArg) are supported.
