...
Access settings are located on the **ACL** (Access Control List) tab in the [interface](ui.md) of the clique. There, you’ll find:
...
For information on how to manage access permissions, see the [section](../../how-to-guides/cliques/manage-access.md).
