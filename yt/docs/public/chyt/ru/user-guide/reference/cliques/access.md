...
Настройки доступа расположены на вкладке **ACL**(Access Control List) в [интерфейсе](ui.md) клики. В нём вы найдёте:
...
Как управлять правами доступа читайте в [разделе](../../how-to-guides/cliques/manage-access.md)
