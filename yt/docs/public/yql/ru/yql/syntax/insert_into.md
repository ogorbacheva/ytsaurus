...
Запись возможна только в [сортированные динамические таблицы]({{yt-docs-root}}/user-guide/dynamic-tables/sorted-dynamic-tables), которые уже должны существовать перед запуском запроса.
