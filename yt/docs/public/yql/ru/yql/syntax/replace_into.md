...
- Целевая таблица должна быть [сортированной динамической таблицей]({{yt-docs-root}}/user-guide/dynamic-tables/sorted-dynamic-tables).
- Целевая таблица должна быть [примонтирована]({{yt-docs-root}}/user-guide/dynamic-tables/operations#mount_table).
